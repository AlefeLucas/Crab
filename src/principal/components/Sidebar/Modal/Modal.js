...
export class Modal extends Component {
    ...
    render() {
        return (
          ...
          <img src={require("./../../../images/icon-awesome-camera.png")} alt="Imagem de uma camera"
               className="pointer modal-float-image"/>
                ...
                <select className="modal-button"
                    ...
                    <option name="faccao-jedi"
                            className="modal-button">Jedi
                    </option>
                    <option name="faccao-sith"
                            className="modal-button">Sith
                    </option>
                    <option name="faccao-cacadores"
                            className="modal-button">Bounty Hunter
                    </option>
                </select>
                <Link to={'/'}>
