...
export class SignUp extends Component {
    ...
    handleSignUp(e) {
        ...
        let typedConfirm = this.refs.confirm.value;


    }

    validateEmail(e){
        if(defaultUsers.filter(value => value.email === this.refs.email.value).length){
    ...
    validateUsername(e){
        ...
        } else if(defaultUsers.filter(value => value.username === this.refs.username.value).length){
                    ...
                    <div className="superlogin">
                        <div className="caixa-login">
                            <div className="cabecalho-login">
                                ...
                                <div>
                                    <svg ref="jedilogo" id="jedilogo" className="imagens-login" xmlns="http://www.w3.org/2000/svg" width="42.133" height="42.81" viewBox="0 0 42.133 42.81">
                            ...
                            <form className="form-login" onSubmit={this.handleSignUp.bind(this)}>
                                <div className="area-login">
                                    ...
                                    <input className="area-text-login" type="text" name="username"
                                           placeholder="Username" ref="username" onChange={this.validateUsername.bind(this)}/>
                                </div>
                                <div className="area-login">
                                ...
                                <div className="area-login">
                                    ...
                                    <input id="password-text" className="area-text-login" type="password" name="senha"
                                           placeholder="Senha" ref="password"  onChange={this.validatePassword.bind(this)}/>
                                </div>
                                <div className="area-login">
                                    <img src={keyIcon} className="form-icon"/>
                                    ...
                                    <input id="confirm-password-text" className="area-text-login" type="password"
                                           name="senha"
                                           placeholder="Confirmar Senha" ref="confirm" onKeyUp={this.validatePassword.bind(this)}/>
                                </div>
                                <div className="area-login">

                                    <img src={factionIcon} className="form-icon"/>
                                    <select required className="area-text-login" name="example" value={this.state.faction} onChange={this.factionChange.bind(this)}>
